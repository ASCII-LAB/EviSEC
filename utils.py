...
def create_parser():
    ...
    parser.add_argument('--EDL',default="none", type=str, choices=['none', 'evisec', 'evisec++'],  help='The detect mode of EviSEC. Choose from: "none", "evisec", "evisec++".')
    parser.add_argument('--OOD',default="none", type=str, choices=['SM', 'FI'],  help='The ood mode. Choose from: "none", "SM", "FI".')
    return parser
